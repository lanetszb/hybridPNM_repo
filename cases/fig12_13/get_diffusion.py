...
pressure_dns[left-1] = 4.e+6

pressure_pnm_1 = data_pnm['P_array'].tolist()
pressure_pnm_2 = [4.e6] * 10
...
srpDep_dns[left-1] = 7.258298654795323
...
ax.legend(lns1, labs1, bbox_to_anchor=[0., 0.62], loc='center left')

plt.savefig('fig13_adsorption1D.pdf', format="pdf",
            bbox_inches='tight')
plt.show()
