...
t_max = 70
t_bc = t_max
t_step_out_coarse = t_max / 700
t_step_out_fine = t_max / 7000
...
cells_file_name = 'two_phase_sorp.pvd'
...
cells_file_name = 'two_phase_sorp_M.pvd'
cells_files_names = list()
cells_files_descriptions = list()
for i in range(len(ts_out_coarse)):
    time = ts_out_coarse[i]
...
P_array = P0M_array_times[224][0:32]
alpha1M = alpha1M_array_times[224][0:32]
