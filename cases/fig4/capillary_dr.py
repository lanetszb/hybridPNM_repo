...
legend_1 = ax.legend(handles=[line1, line2], scatterpoints=1, frameon=True, labelspacing=1, bbox_to_anchor=(1.01, 0.63))
...
ax.legend(lns1, labs1, bbox_to_anchor=(0.371, 0.63))

plt.savefig('fig4_capillary_dr_1d.pdf', format="pdf",
            bbox_inches='tight')
